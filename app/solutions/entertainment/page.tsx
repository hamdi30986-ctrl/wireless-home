    ...
    <>
        ...
        <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-3xl p-8 md:p-10 border border-gray-200 shadow-md">
                ...
                <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">{t.entertainment.features.scenes.title}</h3>
                <p className="text-gray-600 leading-relaxed mb-6">{t.entertainment.features.scenes.description}</p>
            ...
            <div className="bg-white rounded-3xl p-8 md:p-10 border border-gray-200 shadow-md">
                ...
                <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">{t.entertainment.features.universal.title}</h3>
                <p className="text-gray-600 leading-relaxed mb-6">{t.entertainment.features.universal.description}</p>
            ...
            <div className="bg-white rounded-3xl p-8 md:p-10 border border-gray-200 shadow-md">
                ...
                <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">{t.entertainment.features.streaming.title}</h3>
                <p className="text-gray-600 leading-relaxed mb-6">{t.entertainment.features.streaming.description}</p>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">{t.entertainment.automation.automatic.description}</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">{t.entertainment.automation.paused.description}</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">{t.entertainment.automation.gaming.description}</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-24 md:py-32 bg-gray-50 w-full overflow-hidden relative">
        ...
        <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
            {t.entertainment.hardware.heading1} <br /> {t.entertainment.hardware.heading2}
          </h2>
          <p className="text-lg text-gray-600 mb-16 max-w-3xl mx-auto">{t.entertainment.hardware.subheading}</p>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-left">
            <div className="p-8 bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">{t.entertainment.hardware.remotes.description}</p>
            </div>
            ...
            <div className="p-8 bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">{t.entertainment.hardware.audio.description}</p>
            </div>
            ...
            <div className="p-8 bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">{t.entertainment.hardware.projectors.description}</p>
            </div>
          </div>
      ...
      {/* CTA SECTION - Grid marks removed */}
      <section 
