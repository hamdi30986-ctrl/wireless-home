    ...
    <>
          ...
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-5" style={{ backgroundColor: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.15)' }}>
                ...
                <span className="text-xs font-semibold uppercase tracking-[0.15em]" style={{ color: 'rgba(255,255,255,0.85)' }}>{t.curtains.badge}</span>
              </div>
              ...
              <p className="text-base sm:text-lg font-light leading-relaxed" style={{ color: 'rgba(255,255,255,0.8)' }}>{t.curtains.subheading}</p>
            </motion.div>
          </div>
        </div>
      </section>
        ...
        <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-3xl p-8 md:p-10 border border-gray-200 shadow-md">
                ...
                <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">{t.curtains.features.schedule.title}</h3>
                <p className="text-gray-600 leading-relaxed mb-6">{t.curtains.features.schedule.description}</p>
            ...
            <div className="bg-white rounded-3xl p-8 md:p-10 border border-gray-200 shadow-md">
                ...
                <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">{t.curtains.features.remote.title}</h3>
                <p className="text-gray-600 leading-relaxed mb-6">{t.curtains.features.remote.description}</p>
            ...
            <div className="bg-white rounded-3xl p-8 md:p-10 border border-gray-200 shadow-md">
                ...
                <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">{t.curtains.features.scenes.title}</h3>
                <p className="text-gray-600 leading-relaxed mb-6">{t.curtains.features.scenes.description}</p>
        ...
        <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12 max-w-5xl mx-auto">
            <div className="group bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-indigo-500/30 transition-all duration-500">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">{t.curtains.automation.temperature.title}</h3>
                  <p className="text-gray-400 leading-relaxed">{t.curtains.automation.temperature.description}</p>
                </div>
              </div>
            </div>
            ...
            <div className="group bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-indigo-500/30 transition-all duration-500">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">{t.curtains.automation.privacy.title}</h3>
                  <p className="text-gray-400 leading-relaxed">{t.curtains.automation.privacy.description}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-indigo-500/20 transition-all duration-300 text-center">
              ...
              <p className="text-sm text-gray-500">{t.curtains.automation.morning.description}</p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-indigo-500/20 transition-all duration-300 text-center">
              ...
              <p className="text-sm text-gray-500">{t.curtains.automation.away.description}</p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-indigo-500/20 transition-all duration-300 text-center">
              ...
              <p className="text-sm text-gray-500">{t.curtains.automation.wind.description}</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="flex-1 lg:max-w-xl">
              ...
              <p className="text-lg text-gray-600 mb-10 leading-relaxed">{t.curtains.hardware.subheading}</p>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4 p-4 bg-white rounded-xl shadow-sm border border-gray-100">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{t.curtains.hardware.motors.description}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 p-4 bg-white rounded-xl shadow-sm border border-gray-100">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{t.curtains.hardware.tracks.description}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 p-4 bg-white rounded-xl shadow-sm border border-gray-100">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{t.curtains.hardware.blinds.description}</p>
                  </div>
                </div>
              </div>
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 text-white">{t.curtains.cta.heading}</h2>
            <p className="text-xl mb-4 max-w-2xl mx-auto text-white/90">{t.curtains.cta.subheading}</p>
            <p className="text-sm mb-10 text-white/70">{t.curtains.ctaInfo}</p>

            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                href="/book"
                className="group flex items-center gap-3 px-8 py-4 bg-white font-semibold rounded-xl hover:bg-gray-100 transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-0.5 text-indigo-600"
              >
              ...
              <a
                ...
                className="group flex items-center gap-3 px-8 py-4 font-semibold rounded-xl transition-all duration-300 bg-white/95 text-gray-900 border border-black/5"
              >
