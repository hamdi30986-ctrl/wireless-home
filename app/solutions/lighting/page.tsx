          ...
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-5" style={{ backgroundColor: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.15)' }}>
                ...
                <span className="text-xs font-semibold uppercase tracking-[0.15em]" style={{ color: 'rgba(255,255,255,0.85)' }}>{t.lighting.badge}</span>
              </div>
              ...
              <p className="text-base sm:text-lg font-light leading-relaxed" style={{ color: 'rgba(255,255,255,0.8)' }}>{t.lighting.subheading}</p>
            </motion.div>
          </div>
        </div>
      </section>
